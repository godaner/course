...
public class OnlineUserMethodArgumentResolver extends CommonUtil implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        if (null == sessionUser) {
            webRequest.setAttribute("msg", "您已离线",NativeWebRequest.SCOPE_REQUEST);
            webRequest.setAttribute("forward", "forward:/courses/list",NativeWebRequest.SCOPE_REQUEST);
            throw new UsersException("OnlineUserMethodArgumentResolver sessionUser is null !! sessionUser is :" + sessionUser);
        }
        //get user from db
