...
@Aspect
@Order(4)
public class AjaxOnlineAdminAop extends CommonUtil {
    @Autowired
    private AdminService adminService;

    @Pointcut("execution(* com.course.controller..*.*(..))&&@annotation(com.course.aop.RequiredAdminLogin)&&@annotation(org.springframework.web.bind.annotation.ResponseBody)")
