...
CREATE TABLE `course_tag_realations`  (
  ...
  `course_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 90 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
CREATE TABLE `courses`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11265 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Compact;
...
INSERT INTO `courses` VALUES (11252, 1, 1524633554, 1524633609, '/courses/img/ad3d7248-2873-425e-95bb-e8740f447138', '2017版 C++基础教程完整版', '第一阶段C语言提高; 第二阶段数据结构; 第三阶段C++开发编程;', 1, 0, 15);
INSERT INTO `courses` VALUES (11253, 1, 1524634658, 1524634712, '/courses/img/f4305b4a-6999-4104-92a5-bd67d9dded73', 'JS全面教程', '', 0, 0, 0);
INSERT INTO `courses` VALUES (11254, 1, 1524634883, 1524635002, '/courses/img/f221958d-b460-467c-89a4-196da94d9518', 'JavaWeb图书管理系统视频', 'JavaWeb图书管理系统主要目的是实现图书馆的信息化管理。图书馆的主要业务就是新书的借阅和归还，因此系统最核心的功能便是实现图书的借阅和归还。', 0, 0, 0);
INSERT INTO `courses` VALUES (11255, 1, 1524635071, 1524635102, '/courses/img/360b19f2-faba-44db-98e3-ee71e111b1b0', '美食美刻网站制作实战', '本视频系统的讲解了如何制作一个网站，该视频的起点是针对有一定的html+css+JavaScript基础的学员。', 0, 0, 0);
INSERT INTO `courses` VALUES (11256, 1, 1524635217, 1524635232, '/courses/img/66dc9113-e697-404b-a11f-0862f1903871', '百度外卖项目教程', 'Web前端进阶案例练习，运用ajax和JavaScript完成手机端页面。', 0, 0, 0);
INSERT INTO `courses` VALUES (11257, 1, 1524635313, 1524724059, '/courses/img/211d95e5-8647-4e40-89a9-8eb43448b242', ' Ajax从入门到精通', '1、异步      2、XMLHttpRequest      3、XML      4、Jason      5、兼容性      6、封装Ajax工具函数      7、jQuery中的ajax      8、案例练习', 0, 0, 5);
INSERT INTO `courses` VALUES (11258, 1, 1524635420, 1524635436, '/courses/img/9cfb6441-fd85-4879-83ba-9f46a87b3446', 'Python入门教程完整版', '本套教程15天  学前环境搭建  1-3   天内容为Linux基础命令  4-13  天内容为Python基础教程  14-15 天内容为 飞机大战项目演练', 0, 0, 0);
INSERT INTO `courses` VALUES (11259, 1, 1524635524, 1524635541, '/courses/img/557d1ca7-5561-45ee-85e3-5e42c0839190', 'Scrapy教程', '此课程为Python学科爬虫项目实战Scrapy框架课程。', 0, 0, 10);
INSERT INTO `courses` VALUES (11260, 1, 1524635668, 1524635687, '/courses/img/4ff4980d-3760-4e2f-84c7-96d6459ab57f', ' BootStrap教程', '第1课：bootstrap介绍 第2课：引入bootstrap环境2 第3课：以移动设备为优先，窗口和移动设备一致 第4课：排版颜色 第5课：列表 第6课：表格样式 第7课：响应式表格和状态类 第8课：响应式图片 第9课：栅格系统 第10课：栅格系统案例 第11课：栅格系统响应式', 0, 0, 0);
INSERT INTO `courses` VALUES (11261, 1, 1524636011, 1524636083, '/courses/img/1d705461-a737-4191-8730-19c61fdbd717', 'PHP办公留言系统', '', 0, 0, 0);
...
INSERT INTO `courses` VALUES (11263, 1, 1524636204, 1524636222, '/courses/img/d7000396-ab9c-4656-8f7e-af6482ac2ba5', 'Java交通面试题', '', 0, 0, 0);
INSERT INTO `courses` VALUES (11264, 1, 1524636406, 1524636426, '/courses/img/6431f1a0-34d5-46b3-b983-cba3a2a3ee80', 'Linux网络编程', '', 0, 0, 0);
...
INSERT INTO `tag_groups` VALUES (14, 1, 1525339712, 1525339712, '12313');
...
INSERT INTO `tags` VALUES (32, 1, 1525339607, 1525339607, '123');
...
CREATE TABLE `users`  (
  ...
  `img_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '用户头像url',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 68 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '前端用户表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 1517461275, 1518404749, 1, 'root', '123', 3, 1517461275, '6666666666666666666666', '/users/img/5d103736-07f4-4fa4-a53a-1b64b0d47e14');
...
INSERT INTO `users` VALUES (66, 1519702691, 1524629862, 1, 'xiaoyu', '123', 2, 1519702691, '', '/users/img/e28ebe4f-db87-45c7-bc5b-80652f0c4dd5');
